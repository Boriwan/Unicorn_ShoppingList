...
const Errors = require("../api/errors/nakupni-main-error.js");
...
const logger = LoggerFactory.get("NakupniMainAbl");

class NakupniMainAbl {
  constructor() {
...
module.exports = new NakupniMainAbl();
